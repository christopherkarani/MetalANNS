...
kernel void cosine_distance_indexed_f16(
    device const half *query [[buffer(0)]],
    device const half *corpus [[buffer(1)]],
    device const uint *neighborIDs [[buffer(2)]],
...
kernel void l2_distance_indexed_f16(
    device const half *query [[buffer(0)]],
    device const half *corpus [[buffer(1)]],
    device const uint *neighborIDs [[buffer(2)]],
    device float *output [[buffer(3)]],
...
kernel void inner_product_distance_indexed_f16(
    device const half *query [[buffer(0)]],
    device const half *corpus [[buffer(1)]],
    device const uint *neighborIDs [[buffer(2)]],
    device float *output [[buffer(3)]],
